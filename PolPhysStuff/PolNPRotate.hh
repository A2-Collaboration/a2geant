...
inline G4double PolNPRotate::Ay( G4double pp, G4double thp )
{
  ...
  G4double mass;
  //  G4cout<<pp<<" "<<pp/MeV<<" "<<thp/deg<<G4endl;
  ...
  if(fScatType==EScatPN) Ap=-fAyh->GetBinContent(fAyh->FindFixBin(pp/MeV,90-thp/deg)); //SAID is for NP, for PN must switch sign and angle
  else Ap=fAyh->GetBinContent(fAyh->FindFixBin(pp/MeV,thp/deg));
  
  //G4cout<<fAyh->GetName()<<"  Ap "<<Ap<<" "<<pp/MeV<<" "<<thp/deg<<" "<<fScatType<<" "<<fAyh->FindFixBin(pp/MeV,thp/deg)<<G4endl;
  //G4cout<<"Ap "<<Ap<<" "<<pp/MeV<<" "<<" "<<fScatType<<" "<<90-thp/deg<<G4endl;
  ...
  //G4cout<<"****Ap "<<Ap<<" "<<pp/MeV<<" "<<" "<<fScatType<<" "<<thp/deg<<G4endl;
  return Ap;
}
