...
fMotherLogic=MotherLogical;
 ...
 G4Box* MyBox=new G4Box("Box", 60.0*CLHEP::cm, 60.0*CLHEP::cm, 36.0*CLHEP::cm);
 fMyLogic=new G4LogicalVolume(MyBox, fNistManager->FindOrBuildMaterial("G4_AIR"), "Box");
 fMyPhysi=new G4PVPlacement(0, G4ThreeVector(-12.0*CLHEP::cm,0.0*CLHEP::cm,133*CLHEP::cm), fMyLogic, "MyBox", fMotherLogic, false, 1);
