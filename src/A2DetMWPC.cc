...
//   G4Tubs* fWS1U=new G4Tubs("fWS1U",5.56*CLHEP::cm,8.16*CLHEP::cm,0.95*CLHEP::cm,0*CLHEP::deg,360*CLHEP::deg);
//   fWS1ULogic = new G4LogicalVolume(fWS1U,fNistManager->FindOrBuildMaterial("A2_FGLASS"),"WS1UL");

//   G4Tubs* fWS1D=new G4Tubs("fWS1D",5.56*CLHEP::cm,8.16*CLHEP::cm,0.95*CLHEP::cm,0*CLHEP::deg,360*CLHEP::deg);
//   fWS1DLogic = new G4LogicalVolume(fWS1D,fNistManager->FindOrBuildMaterial("A2_FGLASS"),"WS1DL");

//   G4Cons* fSC1U = new G4Cons("fSC1U",5.56*CLHEP::cm,8.16*CLHEP::cm,5.56*CLHEP::cm,7.16*CLHEP::cm,1.275*CLHEP::cm,0*CLHEP::deg,360*CLHEP::cm);
//   fSC1ULogic = new G4LogicalVolume(fSC1U,fNistManager->FindOrBuildMaterial("A2_FGLASS"),"SC1UL");

//   G4Cons* fSC1D= new G4Cons("fSC1D",5.56*CLHEP::cm,7.16*CLHEP::cm,5.56*CLHEP::cm,8.16*CLHEP::cm,1.275*CLHEP::cm,0*CLHEP::deg,360*CLHEP::cm);
//   fSC1DLogic = new G4LogicalVolume(fSC1D,fNistManager->FindOrBuildMaterial("A2_FGLASS"),"SC1DL");
				   
//   G4Tubs *fWS2U = new G4Tubs("fWS2U", 8.45*CLHEP::cm,9.98*CLHEP::cm,2.525*CLHEP::cm,0*CLHEP::deg,360*CLHEP::deg);
//   fWS2ULogic = new G4LogicalVolume(fWS2U,fNistManager->FindOrBuildMaterial("A2_FGLASS"),"WS2UL");
 
//   G4Tubs *fWS2D = new G4Tubs("fWS2D", 8.45*CLHEP::cm,9.98*CLHEP::cm,2.525*CLHEP::cm,0*CLHEP::deg,360*CLHEP::deg);
...
//   G4Tubs *fALTU = new G4Tubs("ALTU",8.2*CLHEP::cm,8.4*CLHEP::cm,6.05*CLHEP::cm,0*CLHEP::deg,360*CLHEP::deg);
