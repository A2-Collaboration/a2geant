...
G4VPhysicalVolume* A2DetNestPID::Construct1(G4LogicalVolume* MotherLogical,G4double Z0){
...
void A2DetNestPID::MakeDetector1(){
...
void A2DetNestPID::MakeSingleDetector(){
 //Constructor for right angular wedge!
 //Used for PID I and PID II
  fNestPID=new G4Trap("PID",fpid_z,fpid_thick,fpid_xl,fpid_xs);
...
void A2DetNestPID::MakePhotomultipliers(){
...
void A2DetNestPID::MakeSupports(){
