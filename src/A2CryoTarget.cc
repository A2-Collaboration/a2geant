...
G4VPhysicalVolume* A2CryoTarget::Construct(G4LogicalVolume *MotherLogic, G4double Z0){
  ...
  //G4double l_CU64 = 16.6*cm - (r_CU64/tan(31.*CLHEP::deg));// ! See target manual
  ...
  //G4double l_cell = 10.0*CLHEP::cm ;  // For 10-cm cell
  ...
  G4cout<<"Target center "<<(-l_trgt/2. + l_CU64 + l_lD2A + t_lD2B - r_lD2B)/CLHEP::cm <<" "<<l_CU64 + (l_lD2A - l_trgt)/2.-tm+0.25*CLHEP::cm<<G4endl;
