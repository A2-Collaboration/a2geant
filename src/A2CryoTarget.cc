...
G4VPhysicalVolume* A2CryoTarget::Construct(G4LogicalVolume *MotherLogic, G4double Z0){
 ...
 //c Parameters for the tmat supply tube
  ...
  new G4PVPlacement(0,G4ThreeVector(0,0, Z0 -l_flangeo/2.),CFKTLogic,"CFKT",fMyLogic,false,1);
  ...
  new G4PVPlacement(0,G4ThreeVector(0,0,Z0 + l_trgt/2. - l_flangeo/2.),FLA1Logic,"FLA1",fMyLogic,false,2);
  ...
  new G4PVPlacement(0,G4ThreeVector(0,0,Z0 + l_trgt/2. - l_flangeo - l_flangei/2.),FLA2Logic,"FLA2",fMyLogic,false,3);
  ...
  new G4PVPlacement(0,G4ThreeVector(0,0,Z0 + l_trgt/2. + sqrt(r_kapd*r_kapd-(r_flangeo-t_flangeo)*(r_flangeo-t_flangeo))),KAPDLogic,"KAPD",fMyLogic,false,4);
  ...
  new G4PVPlacement(0,G4ThreeVector(0,0,(Z0 + l_CU64 + l_lD2A - l_trgt)/2.),KAPALogic,"KAPA",fMyLogic,false,5);
 ...
 new G4PVPlacement(0,G4ThreeVector(0,0, Z0 -l_trgt/2. + l_CU64 + l_lD2A + t_lD2B - r_lD2B),KAPBLogic,"KAPB",fMyLogic,false,6);
  ...
  new G4PVPlacement(0,G4ThreeVector(0,0,Z0 - l_trgt/2. + l_CU64 - t_lD2C + r_lD2C),KAPCLogic,"KAPC",fMyLogic,false,7);
  ...
  ///////////////////////////////
    ...
    new G4PVPlacement(0,G4ThreeVector(0,0,Z0 + l_CU64 + (l_lD2A - l_trgt)/2.),LD2ALogic,"LD2A",fMyLogic,false,8);
    ...
    new G4PVPlacement(0,G4ThreeVector(0,0,Z0 -l_trgt/2. + l_CU64 + l_lD2A + t_lD2B - r_lD2B),LD2BLogic,"LD2B",fMyLogic,false,9);
    ...
    new G4PVPlacement(0,G4ThreeVector(0,0,Z0 -l_trgt/2. + l_CU64 - t_lD2C + r_lD2C),LD2CLogic,"LD2C",fMyLogic,false,10);
    ...
    new G4PVPlacement(0,G4ThreeVector(0,0,Z0 + l_lD2D/2. - l_trgt/2.),LD2DLogic,"LD2D",fMyLogic,false,11);
  ...
  new G4PVPlacement(0,G4ThreeVector(0,0,Z0 + l_CU64/2. - l_trgt/2.),CU64Logic,"CU64",fMyLogic,false,12);
