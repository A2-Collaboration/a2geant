...
//   G4Tubs *BeamLine=new G4Tubs("BeamLine",0.,1*CLHEP::cm,2*CLHEP::m,0,2*3.1415);
...
{ 
 ...
 //Wire Chamber Material. 74.5% Ar, 25% ethane, 0.5% freon. Density is 0.046g/CLHEP::cm3.
 ...
 // NistManager->RegisterMaterial(new G4Material("A2_LD2", z=1., a= 2.014*CLHEP::g/CLHEP::mole, density= 0.162*CLHEP::g/cm3));
...
G4Element* H  = new G4Element("Hydrogen",symbol="H" , z= 1., a= 1.01*CLHEP::g/mole);
...
G4Material* NaI=new G4Material("NaI", density= 3.67*CLHEP::g/cm3, ncomponents=2);
