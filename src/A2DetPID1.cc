...
G4VPhysicalVolume* A2DetPID1::Construct1(G4LogicalVolume* MotherLogical,G4double Z0){
...
void A2DetPID1::MakePhotomultipliers(){
...
void A2DetPID1::MakeLightGuide1(){
